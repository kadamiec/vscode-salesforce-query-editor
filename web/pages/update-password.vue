...
export default {
    ...
    data: () => {
        return {
            user: {
                oldPassword: '07021994aA@',
                newPassword: '07021994aA@'
            },
            error: null,
    ...
    methods: {
        onClickChangePassword(){
            ...
            this.$axios.post(`https://api.keygen.sh/v1/accounts/${process.env.KEYGEN_ACCOUNT_ID}/users/${this.auth.userId}/actions/update-password`,
                {
                    "meta": {
