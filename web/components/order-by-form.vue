<template>
    <b-card v-if="orderBy" no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
            <b-button block v-b-toggle.group-by-accordion class="vscode-button btn">Sort</b-button>
        </b-card-header>
            ...
            <b-card-body style="padding: 5px;">
                <div class="d-flex">
                    <div class="d-flex flex-column mr-2 w-100">
                        ...
                        <select id="orderByDirection" v-model="orderBy.order" @change="onUpdateOrderBy">
                    ...
                    <div class="d-flex flex-column  w-100">
                        ...
                        <select id="nullsOrder" v-model="orderBy.nullsOrder" @change="onUpdateOrderBy">
                            <option :value="null"></option>
